    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('TIME', 'Time'), ('TEXT', 'Text'), ('NUMBER', 'Number')], default='Time', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('black', 'Black'), ('dimgray', 'Dim Gray'), ('gray', 'Gray'), ('darkgray', 'Dark Gray'), ('silver', 'Silver'), ('lightgray', 'Light Gray'), ('gainsboro', 'Gainsboro'), ('red', 'Red'), ('brown', 'Brown'), ('orangered', 'Orange Red'), ('orange', 'Orange'), ('yellow', 'Yellow'), ('yellowgreen', 'Yellow Green'), ('green', 'Green'), ('lightseagreen', 'Light Green'), ('aqua', 'Aqua'), ('deepskyblue', 'Deep Sky Blue'), ('royalblue', 'Royal Blue'), ('mediumslateblue', 'Medium Slate'), ('orchid', 'Orchid')], max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=64, null=True)),
                ('conditions', models.ManyToManyField(to='forecast.condition')),
                ('value_variable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='forecast.forecastvariable')),
            ],
        ),
        migrations.AddField(
